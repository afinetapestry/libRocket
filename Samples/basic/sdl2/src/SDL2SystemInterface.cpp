...
void SDL2SystemInterface::ActivateKeyboard()
{
	SDL_StartTextInput();
}

void SDL2SystemInterface::DeactivateKeyboard()
{
	SDL_StopTextInput();
}

void SDL2SystemInterface::Release()
{
	// do nothing (so far)
}

int SDL2SystemInterface::GetKeyModifiers() const
{
    int temp = 0;
...
Rocket::Core::Input::KeyIdentifier SDL2SystemInterface::TranslateKey(const SDL_Keycode& key) const
{
    switch(key)
	{
        case SDLK_a:
...
int SDL2SystemInterface::TranslateButton(int button) const
{
